...
public class EventLocalListActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (tokenManager.getToken() == null) {
            startActivity(new Intent(EventLocalListActivity.this, LoginActivity.class));
            finish();
        }
                 ...
                 messageCall.enqueue(new Callback<Message>() {
                     ...
                     public void onResponse(Call<Message> messageCall, Response<Message> response) {
                         ...
                         if (response.isSuccessful()) {
                             ...
                             Intent i = new Intent(EventLocalListActivity.this, LoginActivity.class);
                             ...
                             startActivity(new Intent(EventLocalListActivity.this, LoginActivity.class));
                             finish();
                             Toast.makeText(EventLocalListActivity.this,"Successful logout",Toast.LENGTH_LONG).show();
                         }
                     }
